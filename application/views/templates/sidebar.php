<div id="app">
        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="<?= base_url(); ?>"><img src="<?= base_url() . 'dist/'; ?>assets/compiled/svg/iconwafood.svg" alt="Logo" srcset="" /></a>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item">
                        <a id="logwafood" class="sidebar-link">
                            <i class="bi bi-arrow-left-circle-fill"></i>
                            <span id="logwafood">Keluar</span>
                        </a>
                    </li>
    ...
    <script>
        document.getElementById("logwafood").addEventListener("click", (e) => {
            Swal.fire({
